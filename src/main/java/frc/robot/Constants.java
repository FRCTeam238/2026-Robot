...
public class Constants {
    ...
    public class LauncherConstants {
        ...
        public static final double launchSpeedNear = 43; // Value in RPS
    ...
    public class VisionConstants {
        ...
        public static double passBlue = Units.inchesToMeters(60); // X distance in meters
        public static double passRed = Units.inchesToMeters(650.9 - 60); // used "- 60" for if we want to change how close we shoot to the wall
